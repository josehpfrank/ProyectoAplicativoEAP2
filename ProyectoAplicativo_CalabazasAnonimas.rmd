...
```{r}
datatotalfinal = merge.data.frame(data1,VarInd_map_DF , by= 0) #creamos la data final para exportar a formato XLSX
datatotalfinal$V1 = NULL #eliminamos las coordenadas 
datatotalfinal$V2 = NULL
